...
const ZH: Record<string, string> = {
    ...
    "Math font": "数学字体",
    "New Computer Modern is built in. STIX Two and Fira Math are downloaded as verified data packs only when selected.": "New Computer Modern 已内置。只有选择 STIX Two 或 Fira Math 时，才会下载经过校验的数据包。",
    "New Computer Modern is built in. STIX Two and Fira Math are downloaded as verified, non-executable data packs only when selected.": "New Computer Modern 已内置。只有选择 STIX Two 或 Fira Math 时，才会下载经过校验且不可执行的数据包。",
